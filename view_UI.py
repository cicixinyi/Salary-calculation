...
class view_UI:
    ...
    def view_file(self):
        ...
        Picture(self.view_page, image=os.path.join(self.base,'wjj.png'))
        Text(self.view_page, text='选择 年份 并打开 对应文件', size=38)
        Picture(self.view_page, image=os.path.join(self.base,'wj.png'))
        Text(self.view_page, text='在 左下角 选择并点击 月份 ', size=38)
        Picture(self.view_page, image=os.path.join(self.base,'w.png'))
